...
const airlines = getUniqueAirlines(allAircraft);
const aircraftTypes = getUniqueTypes(allAircraft);
      ...
      <Box sx={{ maxWidth: 1200, mx: "auto", px: { xs: 2, md: 4 }, py: 4 }}>
        ...
        <Stack direction="row" spacing={2} sx={{ mb: 3, mt: 2 }}>
          ...
          >
            ...
            <Typography variant="h4" fontWeight={700} sx={{ mt: 0.5, color: "rgba(255,255,255,0.92)" }}>
              {allAircraft.length}
            </Typography>
          </Box>
          <Box
